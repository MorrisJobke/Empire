...
Dasselbe Ergebnis kann man auch mit dem iadd-Befehl erreichen, auf welchen wir aber erst später zurückgreifen werden.
\vspace{0.5em}

Wir deklarieren noch einige Eigenschaften, die wir in der Collection verwenden wollen:
