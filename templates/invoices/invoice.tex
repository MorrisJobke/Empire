...
\setkomavar{fromphone}[\Mobilefone~]{@frommobile}
\setkomavar{fromemail}[\Letter~]{@fromemail \linebreak Ust-IdNr.: @fromustidnr}
...
%---------------------------------------------------------------------------
% Bankverbindung
\setkomavar{frombank}{Bank: @acctname\\
        Kontoinhaber: @fromname\\
        Konto: @acctnr\\
        BLZ: @acctblz}
%---------------------------------------------------------------------------
...
\tiny {Menge} & \tiny {Einheit} & \tiny {Beschreibung} & \tiny {Einzelpreis} & \tiny {Gesamtpreis} \\ \hline
 @quantity & @unit & @description & @price EUR & @total EUR \\ \hline 
\hline
\multicolumn{ 4}{l}{ \textbf{Gesamtsumme} } & \textbf{@alltotal EUR} \\ \hline
\end{tabularx}
